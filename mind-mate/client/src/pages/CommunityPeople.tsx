...
function CommunityPeople() {
    ...
    const [peoplePostDatas, setPeoplePostDatas] = useState([]);
    ...
    const [category, setCategory] = useState("대인관계");
    ...
    const getPost = async () => {
        try {
            ...
            setPeoplePostDatas(res.data.Posts);
        }catch(error){
            console.log('error : ', error);
        }
    }
        ...
        <>
            ...
            <div className='community-container'>
                ...
                <div className='board-container'>
                    ...
                    {  
                            peoplePostDatas.slice(0).reverse().map((postData:any, index) =>(
                                <Post key={index}
