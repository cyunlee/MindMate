...
function CommunityMoney() {
    ...
    const [moneyPostDatas, setMoneyPostDatas] = useState([]);
    ...
    const [category, setCategory] = useState("금전·사업");
    ...
    const getPost = async () => {
        try {
            ...
            setMoneyPostDatas(res.data.Posts);
        }catch(error){
            console.log('error : ', error);
        }
    }
        ...
        <>
            ...
            <div className='community-container'>
                ...
                <div className='board-container'>
                    ...
                    {  
                            moneyPostDatas.slice(0).reverse().map((postData:any, index) =>(
                                <Post key={index}
